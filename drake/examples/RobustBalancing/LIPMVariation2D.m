classdef LIPMVariation2D < NStepCapturabilitySOSSystem
  ...
  methods
    function obj = LIPMVariation2D(g, z_nom, step_max, step_time, inertia_ratio, ux_bnd, uz_bnd, foot_radius,z_inv_degree)
    ...
    function [f,g] = controlAffineDynamics(obj,t,x)
      ...
      g_x_ddot = obj.gravity*z_inv*[-1 q(1) 0] + [0 0 obj.gravity];
      g_z_ddot = [0 obj.gravity 0];
      g_theta_ddot = [0 0 -obj.gravity/obj.inertia_ratio*q(2)];
      
      f = [v;f_x_ddot;f_z_ddot; f_theta_ddot];
      g = [zeros(3); g_x_ddot; g_z_ddot; g_theta_ddot];
      g = g*diag([obj.foot_radius;obj.uz_bnd;obj.ux_bnd]);
    end
