function [ V,B,rho] = switchingControlAlternationsWithImpactNoGTwoStepsAltBounds(x_mss,s_mss,f,g,V0,rho0,B0,T,r,reset_constraint,Vprev)
do_backoff = false;
backoff_ratio = .08;
...
% %   fr = x_mss'*x_mss-1;
% %   [prog, reset_sos] = spotless_add_sprocedure(prog, reset_sos,fr,[x_mss],4);
%   
