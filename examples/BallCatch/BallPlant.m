...
D{1} = [[  q2-q4  -q1+q3       0  (0.1)*q1^2+(0.1)*q2^2+(0.1)*q3^2+(-0.2)*q3*q1+(0.1)*q4^2+(-0.2)*q4*q2  -q2+q4      0   q1-q3  (0.05)*q1^2+(0.05)*q2^2+(0.05)*q3^2+(-0.1)*q3*q1+(0.05)*q4^2+(-0.1)*q4*q2                                                                          0  ]
[      0       0  -q4+q6                                                                      0   q4-q6  q3-q5  -q3+q5  (0.05)*q3^2+(0.05)*q4^2+(0.05)*q5^2+(-0.1)*q5*q3+(0.05)*q6^2+(-0.1)*q6*q4  (0.05)*q3^2+(0.05)*q4^2+(0.05)*q5^2+(-0.1)*q5*q3+(0.05)*q6^2+(-0.1)*q6*q4  ]
[  q2-q6  -q1+q5  -q2+q6  (0.1)*q1^2+(0.1)*q2^2+(0.1)*q5^2+(-0.2)*q5*q1+(0.1)*q6^2+(-0.2)*q6*q2       0  q1-q5       0                                                                          0  (0.05)*q1^2+(0.05)*q2^2+(0.05)*q5^2+(-0.1)*q5*q1+(0.05)*q6^2+(-0.1)*q6*q2  ]];
D{2} = -D{1};
%       x1 = q(1:2);
%       x2 = q(3:4);
%       x3 = q(5:6);
