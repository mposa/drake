...
phi = [
[  (-0.04)+q1^2+q2^2+q3^2+(-2)*q3*q1+q4^2+(-2)*q4*q2  ]
[    (-0.04)+q3^2+q4^2+q5^2+(-2)*q5*q3+q6^2+(-2)*q6*q4  ]
[  (-0.04)+q1^2+q2^2+q5^2+(-2)*q5*q1+q6^2+(-2)*q6*q2  ]];
...
D{1} = [[  q2-q4  -q1+q3  -q2+q4   q1-q3       0      0  (0.1)*q1^2+(0.1)*q2^2+(0.1)*q3^2+(-0.2)*q3*q1+(0.1)*q4^2+(-0.2)*q4*q2  (0.1)*q1^2+(0.1)*q2^2+(0.1)*q3^2+(-0.2)*q3*q1+(0.1)*q4^2+(-0.2)*q4*q2                                                                      0  ]
[      0       0   q4-q6  -q3+q5  -q4+q6  q3-q5                                                                      0  (0.1)*q3^2+(0.1)*q4^2+(0.1)*q5^2+(-0.2)*q5*q3+(0.1)*q6^2+(-0.2)*q6*q4  (0.1)*q3^2+(0.1)*q4^2+(0.1)*q5^2+(-0.2)*q5*q3+(0.1)*q6^2+(-0.2)*q6*q4  ]
[  q2-q6  -q1+q5       0       0  -q2+q6  q1-q5  (0.1)*q1^2+(0.1)*q2^2+(0.1)*q5^2+(-0.2)*q5*q1+(0.1)*q6^2+(-0.2)*q6*q2                                                                      0  (0.1)*q1^2+(0.1)*q2^2+(0.1)*q5^2+(-0.2)*q5*q1+(0.1)*q6^2+(-0.2)*q6*q2  ]];
