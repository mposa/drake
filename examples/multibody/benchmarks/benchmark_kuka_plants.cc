...
int do_main() {
  ...
  1000*duration.count()/num_reps << " microseconds per count." << std::endl;
  ...
  std::cout << "(rigid_body_plant) " << std::to_string(num_autodiff_reps) << "x inertia autodiff calculations took "
      << duration.count() << " miliseconds. " << 1000*duration.count()/num_autodiff_reps << " microseconds per count." << std::endl;
  ...
  std::cout << "(multibody_plant) " << std::to_string(num_reps) << "x inertia calculations took " <<
      duration.count() << " miliseconds. " << 1000*duration.count()/num_reps << " microseconds per count." << std::endl;
